...
int main( int argc, char* argv [] ) {
  if( argc < 5 ){
    std::cerr << "Need to specify two input parameterst image name ch1 (x-axis)>, <Input image name ch2 (y-axis)>, <output image name (scatter plot)>, <OmpNumThreads>." << std::endl;
    exit(1);
  }
