...
save_root_path = '/data/pdata/amerouan/results/'
out_path = save_root_path + data_id +'_RES/'

exe_path= '/data/pdata/amerouan/nano-well-analysis/bin/exe/'
param_path = '/data/pdata/amerouan/nano-well-analysis/parameters/'
...
# Analysis
range_blocks = range(1,2) ## it can be a range or a list
